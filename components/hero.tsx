    ...
    <div className="container mx-auto px-6 py-10 pb-32 flex flex-col gap-20 lg:flex-row">
      ...
      <div className="relative z-20 flex flex-col flex-0 lg:w-1/2">
        ...
        <div className="flex flex-col gap-4 lg:flex-row">
          <Button type="button" variant="btn_green">Book Now</Button>
          <Button type="button" variant="btn_white" icon="/play.svg">How We Work</Button>
        </div>
        <div className="relative z-10">
          <div className="absolute top-4 left-4 rounded-xl bg-gray-90 flex flex-col gap-4 text-white p-3 w-[250px]">
